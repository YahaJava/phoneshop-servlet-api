...
public class ProductDemodataServletContextListener implements ServletContextListener {
    ...
    private List<PriceHistory> addPriceHistory(BigDecimal price) {
        ...
        Currency usd = Currency.getInstance("USD");
        priceHistory.add(new PriceHistory("15.05.2018", price.add(new BigDecimal(50)), usd));
        priceHistory.add(new PriceHistory("02.10.2018", price.add(new BigDecimal(30)), usd));
